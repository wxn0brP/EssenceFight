...
export class BoardUi implements UiComponent {
    ...
    render() {
        ...
        this.ui.aggressor.innerHTML = gameState.data.aggressive === this.index ? "true" : "false";
    ...
    renderCard(div: HTMLDivElement, pos: CardPosition) {
        ...
        const data = gameState.data.cards[boardState.cards[splitPos[0]][+splitPos[1]]] as UnitCard;
